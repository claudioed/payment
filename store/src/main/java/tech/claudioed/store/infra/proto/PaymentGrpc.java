...
public final class PaymentGrpc {
  ...
  public static final String SERVICE_NAME = "store.Payment";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<tech.claudioed.store.infra.proto.PaymentRequest,
      tech.claudioed.store.infra.proto.PaymentResult> METHOD_PAY =
      io.grpc.MethodDescriptor.<tech.claudioed.store.infra.proto.PaymentRequest, tech.claudioed.store.infra.proto.PaymentResult>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "store.Payment", "pay"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              tech.claudioed.store.infra.proto.PaymentRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              tech.claudioed.store.infra.proto.PaymentResult.getDefaultInstance()))
          .build();
  ...
  public static abstract class PaymentImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void pay(tech.claudioed.store.infra.proto.PaymentRequest request,
        io.grpc.stub.StreamObserver<tech.claudioed.store.infra.proto.PaymentResult> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                tech.claudioed.store.infra.proto.PaymentRequest,
                tech.claudioed.store.infra.proto.PaymentResult>(
                  this, METHODID_PAY)))
          .build();
    }
  }
  ...
  public static final class PaymentBlockingStub extends io.grpc.stub.AbstractStub<PaymentBlockingStub> {
    ...
    /**
     */
    public tech.claudioed.store.infra.proto.PaymentResult pay(tech.claudioed.store.infra.proto.PaymentRequest request) {
  ...
  public static final class PaymentFutureStub extends io.grpc.stub.AbstractStub<PaymentFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<tech.claudioed.store.infra.proto.PaymentResult> pay(
        tech.claudioed.store.infra.proto.PaymentRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PAY:
          serviceImpl.pay((tech.claudioed.store.infra.proto.PaymentRequest) request,
              (io.grpc.stub.StreamObserver<tech.claudioed.store.infra.proto.PaymentResult>) responseObserver);
          break;
        default:
  ...
  private static final class PaymentDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return tech.claudioed.store.infra.proto.Store.getDescriptor();
    }
  }
